...
To enable address lookups, select either "electrs" or "Fulcrum" as the Electrum Server in the configuration menu.

You will need the selected Electrum server to be installed and synced before this feature will work. Lookups may be slow or time out altogether while the service is still warming up, or if there are too many other things running on your system.
